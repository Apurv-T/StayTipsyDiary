...
public class activity_cannabis extends toolbar {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner_cigarette = findViewById(R.id.cigarette_spinner);
        ...
        Button btn_add= findViewById(R.id.button_add_can);
        Button btn_del= findViewById(R.id.button_delete_can);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LayoutInflater layoutInflater=LayoutInflater.from(activity_cannabis.this);
                View vv=layoutInflater.inflate(R.layout.activity_add_cannabis,null);
                AlertDialog.Builder alertdialog1=new AlertDialog.Builder(activity_cannabis.this);
        ...
        @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position != 0) {
                    ...
                    AlertDialog.Builder alertdialog=new AlertDialog.Builder(activity_cannabis.this);
